        ...
        <div>
            <Container>
                ...
                <div className="d-flex">
                    ...
                    <div className="p-2">
                        <Link to="/visualizarservico" className="btn btn-outline-primary btn-sm">Serviço</Link>
                        <Link to={"/editarservico/" + data.id}className="btn btn-outline-warning btn-sm m-1">Editar</Link>
                    </div>
                    </div>
