        ...
        <div>
            <Container>
                ...
                <div className="d-flex">
                    ...
                    <div className="p-2">
                        <Link to="/visualizarcliente" className="btn btn-outline-primary btn-sm">Cliente</Link>
                        <Link to={"/editarcliente/" + data.id}className="btn btn-outline-warning btn-sm m-1">Editar</Link>
                    </div>
                    </div>
